...
public class Admin_shop_delete extends JFrame {

	private JPanel contentPane;
	private JTextField textField;
	private DBUtil dbutil=new DBUtil();
	private DeleteShop del =new DeleteShop();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Admin_shop_delete frame = new Admin_shop_delete();
	...
	public Admin_shop_delete() {
		...
		JLabel lblNewLabel = new JLabel("\u8BF7\u8F93\u5165\u60A8\u8981\u5220\u9664\u7684\u5546\u5E97ID");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(StringUtil.isEmpty(id)) {
					...
					try {
						...
						JOptionPane.showMessageDialog(null, del.DeleteS(conn, id));
					}
					catch (Exception ex)
					{
